...
WINGDIA@I D@I@ @@@EHTPP C( (E@`   @`hd$ ELd ea `)0 ALC@HA@  tbid   ADB@RA  `Cdd`  ccda  GLfli`  pe`, E@ ( t ``def  GHd (AP @LT@  @DNAD @D@@@ 
AHDE@A@P@ FC)  A@AAJD@  d`Ade  CL`ir ( @cd`d   bd`$ GLblal``  "`eh, E@!(p` `ded  GH`  AP@ @DPH (  FALGD@@@I TE@D @P@@N@   GLAlea @d`d`  GLblad   `ap`h!)	@H@D@A@  fi`  APIENTRY " @DDA@AB@AX ELDLDAP A	 P@NC A@A tm d @@ FDRI eh `eabP$ bch`  GL`n` " 0		
 	  A FO`` AP@AND@Y ddAdhpP  .  A@eded plad ( @IDBT A   PBLE  @AU@@HGDEHDCDI@P@ B)   @@HEL @I e, GLe`"`  D@bp$  @e`,  Db`$  Dra`d( CL`ht$ BLed!)  Q@D AA@A  GHd A@  HD@I e`+
 ""  ANNst @L`idd *&	
PADED @@I  (A@ A@@@H   FLCL@D@D  @HDDP@@D @D@  C   BLa d `$  ALd q  E bhpe) D@H A@PI di ` A@HD  , DHP``  `dd`T EHdep`    9  DAF DIA@  @@ID @PI 
 P@ GLCOLOR@ ED@D@@D        DLad e dab$ D DLad ` ad ! 
AHFG@IAP FLa` A@ EHDPH  D@ele` ff (ad,      G@d  d 0	 E CDHAP  Dfi`   @AD@  dA`dd`"  (AD (@ @ED A ( P FBDAN B@ABT BLEE GA      FLad A @ABD@P  D@chj`! r  bd, D CHhd` "f!* ALEDAA @ rmad       A elAm dp0a  CLb`d D re`$ Da`a 0 pa`d$ F rhi`  @@AE   @DHA@A TCID @PA@LD@X @@CC(    (CLdbt  Da`g`t  F! E FG@IAP FLad A @A@D   DdCid " a` ( `ype `d $ AD  APA FP@A ( @DDBHDE BLDE DA@A@AA@@ RI@D @P@EB      (DL`"u`   bgdp$ GLebqd  *`)! GHHFD  PA `ma   @A@D@A  dCid  PI D@Q *  BDD EDAILD D@@DD  B@EADD BDE@  
C	     Dehd  PA@FDP GLAndm 0dad ( GLbd AD (``  d!)		
@@@@@ VOa` AP@DDP  eld`" Dd`hf $  ED GHUS *" #`ddh$  SHg`T B  %	
                                      (const GLushort *v);
...
typedef void (APIENTRY * PFNGLTEXC_OrvomnUU[E^TR[ogmclgm{n|gk{uniglen}msy{m.wONwm{eyisvidempOM}z}igoo}ou~acot(GLvooet*romntg~ooktywween,vomfloatignuw} olvnog|eeounmi]O_O^GVMYTYroid(G\{m~u{ysw~klemrGoozeigoo}o}|fcow| GLcoomugngzuoontg~kmotpglug,vomglimpoeo|rya+;]N_ONGE]Q_Invo{veYTYWOW{y(glgnumrtoq}m,(GLwoimzd*terum{;?_}wemevivomd(APIENTRY olSnog~I~veyelGMgnavrcy]^W[OGmiG\mnwoimoeumeO\syzgmcoou~w|eooot(GLo}d{){m+MNONokp_i~mvaw_{enww_eomomotslkom*||enuo voine,asootr_lnoufnglnwqwsuooomMOWO^WWIOP[owoilgMuouotdglcol{v {wmr}|eg~umntgmn}|egosmom gowtm gluo}-~yoodko~{tvomvoitioo~vycgkmo;o~ koswaw_jy~u *-;}{wmngfiwidvoitiE^]W_tzypgnGomovswaxOMnwgouw{ot~oGmdo}glmnwr}mnolonto}nlglsmei;kw}nodOMsizwoileiwiuo_[-ookomvtwlmwowtg|twglo//~}{}owmngvoiti(wienURYentR_nglColorwgblGM~|sc{mn, glnooe~uorue~oewlfooe~uol}o}nwmNovmatm wo{mzeyiwotvy,goOon3frmcn~ glflomun)}zwmngoostig~omdazme~u{{-o|{mowwivoolinup{en|r_lkntfowmgoloW_}ntabluey]Z_KoONiapi(womnump}e~ww},goOmw{iwtisnswlwm{o} k}}.wONgn}mpoovoit,MZientr_lgnwol{sw,(go{rwlvoml ols|o{-ov}uoleglwoovt(c|}eo_[wknWFOG\OevooloSTIGNUWYtw~Oomoz3sv (gooumg|szowt,*wmoinovmatm womnump}}~u~ygo~oolozwuva)Mvytedwgd~oolujytmeovw}n. WNg}wetco}o{MJ_M^GVIMU]evoexUP[OO}_[ glcooowuovtisoow| GLun}}epnwm-*WMootikpirwo{m;MZ}}~uv}fg~oolozsuienW^}intpvoglgG\wonrwsgmo|aWM}m~urf~u}}{_OWiOOdiapig~ooumatiwouv} glgo}orsie,conw|og|uk~urk{;?_MNgmoeuo ktlusymw_[}oncono{w}{-*gmwior*rol_Lho}*gwoeon onuo~hlo-;